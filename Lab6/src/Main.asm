...
.data
	...
	DescriptionTask1 db "1. Calculate sqrt(abs(cos x + sin x))", 0Dh, 0Ah, 0;/r/n
	DescriptionTask2 db "2. Calculate 3a - (a+b)/2 with FPU", 0Dh, 0Ah, 0;/r/n
	DescriptionTask3 db "3. Print some function values", 0Dh, 0Ah, 0;/r/n
