...
.data
	...
	DescriptionTask1 db "1. Use formatting numbers array to string", 0Dh, 0Ah, 0;/r/n
	DescriptionTask2 db "2. Make and change some numbers array", 0Dh, 0Ah, 0;/r/n

	tasksArray dd Exit, Task1, Task2
	tasksArraySize dd 3

	tasksDescriptionsArray dd DescriptionExit, DescriptionTask1, DescriptionTask2
	tasksDescriptionsArraySize dd 3
